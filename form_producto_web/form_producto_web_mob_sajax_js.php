  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_producto_web_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idproducto
  function do_ajax_form_producto_web_mob_validate_idproducto()
  {
    var nomeCampo_idproducto = "idproducto";
    var var_idproducto = scAjaxGetFieldHidden(nomeCampo_idproducto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_web_mob_validate_idproducto(var_idproducto, var_script_case_init, do_ajax_form_producto_web_mob_validate_idproducto_cb);
  } // do_ajax_form_producto_web_mob_validate_idproducto

  function do_ajax_form_producto_web_mob_validate_idproducto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idproducto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_web_mob_validate_idproducto_cb

  // ---------- Validate nombre
  function do_ajax_form_producto_web_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_web_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_producto_web_mob_validate_nombre_cb);
  } // do_ajax_form_producto_web_mob_validate_nombre

  function do_ajax_form_producto_web_mob_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombre";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_web_mob_validate_nombre_cb

  // ---------- Validate imagen
  function do_ajax_form_producto_web_mob_validate_imagen()
  {
    var nomeCampo_imagen = "imagen";
    var var_imagen = scAjaxGetFieldText(nomeCampo_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_web_mob_validate_imagen(var_imagen, var_script_case_init, do_ajax_form_producto_web_mob_validate_imagen_cb);
  } // do_ajax_form_producto_web_mob_validate_imagen

  function do_ajax_form_producto_web_mob_validate_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "imagen";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_web_mob_validate_imagen_cb
  // ---------- Form
  function do_ajax_form_producto_web_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_producto_web_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idproducto = scAjaxGetFieldHidden("idproducto");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_producto_web_mob_submit_form(var_idproducto, var_nombre, var_imagen, var_imagen_ul_name, var_imagen_ul_type, var_imagen_salva, var_imagen_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_producto_web_mob_submit_form_cb);
  } // do_ajax_form_producto_web_mob_submit_form

  function do_ajax_form_producto_web_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idproducto");
  ...
  } // do_ajax_form_producto_web_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_producto_web_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("nombre");
    scAjaxHideErrorDisplay("imagen");
    var var_idproducto = document.F2.idproducto.value;
    ...
    scAjaxProcOn();
    x_ajax_form_producto_web_mob_navigate_form(var_idproducto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_producto_web_mob_navigate_form_cb);
  } // do_ajax_form_producto_web_mob_navigate_form

  function do_ajax_form_producto_web_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idproducto.value = scAjaxGetKeyValue("idproducto");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_producto_web_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_producto_web_mob_navigate_form_cb
  ...
  var ajax_error_list = {
    "idproducto": {"label": "Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["idproducto"][1] = "idproducto";
  ajax_field_mult["nombre"][1] = "nombre";
  ajax_field_mult["imagen"][1] = "imagen";

  var ajax_field_id = {
    "idproducto": new Array("hidden_field_label_idproducto", "hidden_field_data_idproducto"),
