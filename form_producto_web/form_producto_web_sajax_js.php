  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_producto_web" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idproducto
  function do_ajax_form_producto_web_validate_idproducto()
  {
    var nomeCampo_idproducto = "idproducto";
    var var_idproducto = scAjaxGetFieldHidden(nomeCampo_idproducto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_web_validate_idproducto(var_idproducto, var_script_case_init, do_ajax_form_producto_web_validate_idproducto_cb);
  } // do_ajax_form_producto_web_validate_idproducto

  function do_ajax_form_producto_web_validate_idproducto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_web_validate_idproducto_cb

  // ---------- Validate nombre
  function do_ajax_form_producto_web_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_web_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_producto_web_validate_nombre_cb);
  } // do_ajax_form_producto_web_validate_nombre

  function do_ajax_form_producto_web_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombre";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_web_validate_nombre_cb

  // ---------- Validate imagen
  function do_ajax_form_producto_web_validate_imagen()
  {
    var nomeCampo_imagen = "imagen";
    var var_imagen = scAjaxGetFieldText(nomeCampo_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_web_validate_imagen(var_imagen, var_script_case_init, do_ajax_form_producto_web_validate_imagen_cb);
  } // do_ajax_form_producto_web_validate_imagen

  function do_ajax_form_producto_web_validate_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "imagen";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_web_validate_imagen_cb
  // ---------- Form
  function do_ajax_form_producto_web_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_producto_web_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_producto_web_submit_form(var_idproducto, var_nombre, var_imagen, var_imagen_ul_name, var_imagen_ul_type, var_imagen_salva, var_imagen_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_producto_web_submit_form_cb);
  } // do_ajax_form_producto_web_submit_form

  function do_ajax_form_producto_web_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_producto_web_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_producto_web_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_producto_web_navigate_form(var_idproducto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_producto_web_navigate_form_cb);
  } // do_ajax_form_producto_web_navigate_form

  function do_ajax_form_producto_web_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_producto_web_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_producto_web_navigate_form_cb
