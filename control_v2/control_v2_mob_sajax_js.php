  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_v2_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate vacio
  function do_ajax_control_v2_mob_validate_vacio()
  {
    var nomeCampo_vacio = "vacio";
    var var_vacio = scAjaxGetFieldHidden(nomeCampo_vacio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_v2_mob_validate_vacio(var_vacio, var_script_case_init, do_ajax_control_v2_mob_validate_vacio_cb);
  } // do_ajax_control_v2_mob_validate_vacio

  function do_ajax_control_v2_mob_validate_vacio_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_v2_mob_validate_vacio_cb

  // ---------- Validate cuenta
  function do_ajax_control_v2_mob_validate_cuenta()
  {
    var nomeCampo_cuenta = "cuenta";
    var var_cuenta = scAjaxGetFieldText(nomeCampo_cuenta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_v2_mob_validate_cuenta(var_cuenta, var_script_case_init, do_ajax_control_v2_mob_validate_cuenta_cb);
  } // do_ajax_control_v2_mob_validate_cuenta

  function do_ajax_control_v2_mob_validate_cuenta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cuenta";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_v2_mob_validate_cuenta_cb
  // ---------- Form
  function do_ajax_control_v2_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_v2_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_vacio = scAjaxGetFieldHidden("vacio");
    var var_cuenta = scAjaxGetFieldText("cuenta");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_control_v2_mob_submit_form(var_vacio, var_cuenta, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_control_v2_mob_submit_form_cb);
  } // do_ajax_control_v2_mob_submit_form

  function do_ajax_control_v2_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_v2_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_v2_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_v2_mob_navigate_form

  function do_ajax_control_v2_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_v2_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_v2_mob_navigate_form_cb
  ...
  ajax_field_list[0] = "vacio";
  ajax_field_list[1] = "cuenta";
  ...
  var ajax_error_list = {
    ...
    "cuenta": {"label": "Ingrese Nº de cuenta de cliente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["cuenta"][1] = "cuenta";

  var ajax_field_id = {
    "vacio": new Array("hidden_field_label_vacio", "hidden_field_data_vacio"),
    "cuenta": new Array("hidden_field_label_cuenta", "hidden_field_data_cuenta")
  };
