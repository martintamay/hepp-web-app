...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["hepp_____control_v2"]))
   {
      unset($_SESSION['session_sec_aplicacao']["hepp_____control_v2"]);
   }
   ...
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['control_v2_mob']))
   {
      unset($_SESSION['sc_session'][$script_case_init]['control_v2_mob']['sc_redir_atualiz']);
      unset($_SESSION['sc_session'][$script_case_init]['control_v2_mob']['sc_redir_insert']);
   }
   $fecha_janela = false;
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['control_v2_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['control_v2_mob']['sc_outra_jan'])
   {
       $fecha_janela = true;
   }
   if ((isset($nmgp_parms) && $nmgp_parms == "glo_menu") || $fecha_janela)
   {
       if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['control_v2_mob']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['control_v2_mob']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['control_v2_mob']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['control_v2_mob']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['control_v2_mob']['db_changed'])
           {
       ...
       {
           if (!isset($script_case_init) || is_array($script_case_init) || !isset($_SESSION['sc_session'][$script_case_init]['control_v2_mob']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['control_v2_mob']['db_changed'])
           {
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['control_v2_mob']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['control_v2_mob']['embutida_filho'] as $ind => $sc_init)
          {
