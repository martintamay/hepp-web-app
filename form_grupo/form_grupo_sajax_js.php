...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate orden
  function do_ajax_form_grupo_validate_orden()
  {
    var nomeCampo_orden = "orden";
    var var_orden = scAjaxGetFieldHidden(nomeCampo_orden);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_validate_orden(var_orden, var_script_case_init, do_ajax_form_grupo_validate_orden_cb);
  } // do_ajax_form_grupo_validate_orden

  function do_ajax_form_grupo_validate_orden_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_validate_orden_cb

  // ---------- Validate descripcion
  function do_ajax_form_grupo_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_grupo_validate_descripcion_cb);
  } // do_ajax_form_grupo_validate_descripcion

  function do_ajax_form_grupo_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_validate_descripcion_cb
  // ---------- Form
  function do_ajax_form_grupo_submit_form()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_grupo_submit_form(var_orden, var_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_grupo_submit_form_cb);
  ...
  function do_ajax_form_grupo_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_grupo_navigate_form(var_orden, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_grupo_navigate_form_cb);
