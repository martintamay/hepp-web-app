  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_grupo_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate orden
  function do_ajax_form_grupo_mob_validate_orden()
  {
    var nomeCampo_orden = "orden";
    var var_orden = scAjaxGetFieldHidden(nomeCampo_orden);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_mob_validate_orden(var_orden, var_script_case_init, do_ajax_form_grupo_mob_validate_orden_cb);
  } // do_ajax_form_grupo_mob_validate_orden

  function do_ajax_form_grupo_mob_validate_orden_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_mob_validate_orden_cb

  // ---------- Validate descripcion
  function do_ajax_form_grupo_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_grupo_mob_validate_descripcion_cb);
  } // do_ajax_form_grupo_mob_validate_descripcion

  function do_ajax_form_grupo_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_mob_validate_descripcion_cb
  // ---------- Form
  function do_ajax_form_grupo_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_grupo_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_orden = scAjaxGetFieldHidden("orden");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_grupo_mob_submit_form(var_orden, var_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_grupo_mob_submit_form_cb);
  } // do_ajax_form_grupo_mob_submit_form

  function do_ajax_form_grupo_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_grupo_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_grupo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("orden");
    scAjaxHideErrorDisplay("descripcion");
    var var_orden = document.F2.orden.value;
    ...
    scAjaxProcOn();
    x_ajax_form_grupo_mob_navigate_form(var_orden, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_grupo_mob_navigate_form_cb);
  } // do_ajax_form_grupo_mob_navigate_form

  function do_ajax_form_grupo_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.orden.value = scAjaxGetKeyValue("orden");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_grupo_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_grupo_mob_navigate_form_cb
