  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_publicacion_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idpublicacion
  function do_ajax_form_publicacion_mob_validate_idpublicacion()
  {
    var nomeCampo_idpublicacion = "idpublicacion";
    var var_idpublicacion = scAjaxGetFieldHidden(nomeCampo_idpublicacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_publicacion_mob_validate_idpublicacion(var_idpublicacion, var_script_case_init, do_ajax_form_publicacion_mob_validate_idpublicacion_cb);
  } // do_ajax_form_publicacion_mob_validate_idpublicacion

  function do_ajax_form_publicacion_mob_validate_idpublicacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idpublicacion";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_publicacion_mob_validate_idpublicacion_cb

  // ---------- Validate titulo
  function do_ajax_form_publicacion_mob_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldText(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_publicacion_mob_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_publicacion_mob_validate_titulo_cb);
  } // do_ajax_form_publicacion_mob_validate_titulo

  function do_ajax_form_publicacion_mob_validate_titulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "titulo";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_publicacion_mob_validate_titulo_cb

  // ---------- Validate contenido
  function do_ajax_form_publicacion_mob_validate_contenido()
  {
    var nomeCampo_contenido = "contenido";
    var var_contenido = scAjaxGetFieldText(nomeCampo_contenido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_publicacion_mob_validate_contenido(var_contenido, var_script_case_init, do_ajax_form_publicacion_mob_validate_contenido_cb);
  } // do_ajax_form_publicacion_mob_validate_contenido

  function do_ajax_form_publicacion_mob_validate_contenido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_publicacion_mob_validate_contenido_cb
  // ---------- Form
  function do_ajax_form_publicacion_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_publicacion_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idpublicacion = scAjaxGetFieldHidden("idpublicacion");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_publicacion_mob_submit_form(var_idpublicacion, var_titulo, var_contenido, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_publicacion_mob_submit_form_cb);
  } // do_ajax_form_publicacion_mob_submit_form

  function do_ajax_form_publicacion_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idpublicacion");
  ...
  } // do_ajax_form_publicacion_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_publicacion_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("titulo");
    scAjaxHideErrorDisplay("contenido");
    var var_idpublicacion = document.F2.idpublicacion.value;
    ...
    scAjaxProcOn();
    x_ajax_form_publicacion_mob_navigate_form(var_idpublicacion, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_publicacion_mob_navigate_form_cb);
  } // do_ajax_form_publicacion_mob_navigate_form

  function do_ajax_form_publicacion_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idpublicacion.value = scAjaxGetKeyValue("idpublicacion");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_publicacion_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_publicacion_mob_navigate_form_cb
  ...
  ajax_field_list[0] = "idpublicacion";
  ...
  var ajax_error_list = {
    "idpublicacion": {"label": "Idpublicacion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "idpublicacion": new Array(),
    "titulo": new Array(),
    "contenido": new Array()
  };
  ajax_field_mult["idpublicacion"][1] = "idpublicacion";
