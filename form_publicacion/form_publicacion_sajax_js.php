  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_publicacion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_publicacion_validate_idpublicacion()
  {
    var nomeCampo_idpublicacion = "idpublicacion";
    var var_idpublicacion = scAjaxGetFieldHidden(nomeCampo_idpublicacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_publicacion_validate_idpublicacion(var_idpublicacion, var_script_case_init, do_ajax_form_publicacion_validate_idpublicacion_cb);
  } // do_ajax_form_publicacion_validate_idpublicacion

  function do_ajax_form_publicacion_validate_idpublicacion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_publicacion_validate_idpublicacion_cb

  // ---------- Validate titulo
  function do_ajax_form_publicacion_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldText(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_publicacion_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_publicacion_validate_titulo_cb);
  } // do_ajax_form_publicacion_validate_titulo

  function do_ajax_form_publicacion_validate_titulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "titulo";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_publicacion_validate_titulo_cb

  // ---------- Validate contenido
  function do_ajax_form_publicacion_validate_contenido()
  {
    var nomeCampo_contenido = "contenido";
    var var_contenido = scAjaxGetFieldText(nomeCampo_contenido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_publicacion_validate_contenido(var_contenido, var_script_case_init, do_ajax_form_publicacion_validate_contenido_cb);
  } // do_ajax_form_publicacion_validate_contenido

  function do_ajax_form_publicacion_validate_contenido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_publicacion_validate_contenido_cb
  // ---------- Form
  function do_ajax_form_publicacion_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_publicacion_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_publicacion_submit_form(var_idpublicacion, var_titulo, var_contenido, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_publicacion_submit_form_cb);
  } // do_ajax_form_publicacion_submit_form

  function do_ajax_form_publicacion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_publicacion_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_publicacion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_publicacion_navigate_form(var_idpublicacion, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_publicacion_navigate_form_cb);
  } // do_ajax_form_publicacion_navigate_form

  function do_ajax_form_publicacion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_publicacion_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_publicacion_navigate_form_cb
