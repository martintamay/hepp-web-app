  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_redes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idred
  function do_ajax_form_redes_mob_validate_idred()
  {
    var nomeCampo_idred = "idred";
    var var_idred = scAjaxGetFieldHidden(nomeCampo_idred);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_redes_mob_validate_idred(var_idred, var_script_case_init, do_ajax_form_redes_mob_validate_idred_cb);
  } // do_ajax_form_redes_mob_validate_idred

  function do_ajax_form_redes_mob_validate_idred_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_redes_mob_validate_idred_cb

  // ---------- Validate tipo_red
  function do_ajax_form_redes_mob_validate_tipo_red()
  {
    var nomeCampo_tipo_red = "tipo_red";
    var var_tipo_red = scAjaxGetFieldRadio(nomeCampo_tipo_red);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_redes_mob_validate_tipo_red(var_tipo_red, var_script_case_init, do_ajax_form_redes_mob_validate_tipo_red_cb);
  } // do_ajax_form_redes_mob_validate_tipo_red

  function do_ajax_form_redes_mob_validate_tipo_red_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tipo_red";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_redes_mob_validate_tipo_red_cb

  // ---------- Validate vinculo
  function do_ajax_form_redes_mob_validate_vinculo()
  {
    var nomeCampo_vinculo = "vinculo";
    var var_vinculo = scAjaxGetFieldText(nomeCampo_vinculo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_redes_mob_validate_vinculo(var_vinculo, var_script_case_init, do_ajax_form_redes_mob_validate_vinculo_cb);
  } // do_ajax_form_redes_mob_validate_vinculo

  function do_ajax_form_redes_mob_validate_vinculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "vinculo";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_redes_mob_validate_vinculo_cb
  // ---------- Form
  function do_ajax_form_redes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_redes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idred = scAjaxGetFieldHidden("idred");
    var var_tipo_red = scAjaxGetFieldRadio("tipo_red");
    var var_vinculo = scAjaxGetFieldText("vinculo");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_redes_mob_submit_form(var_idred, var_tipo_red, var_vinculo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_redes_mob_submit_form_cb);
  } // do_ajax_form_redes_mob_submit_form

  function do_ajax_form_redes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idred");
      scAjaxHideErrorDisplay("tipo_red");
      scAjaxHideErrorDisplay("vinculo");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_redes_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_redes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("tipo_red");
    scAjaxHideErrorDisplay("vinculo");
    var var_idred = document.F2.idred.value;
    ...
    scAjaxProcOn();
    x_ajax_form_redes_mob_navigate_form(var_idred, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_redes_mob_navigate_form_cb);
  } // do_ajax_form_redes_mob_navigate_form

  function do_ajax_form_redes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idred.value = scAjaxGetKeyValue("idred");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_redes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_redes_mob_navigate_form_cb
  ...
  ajax_field_list[0] = "idred";
  ajax_field_list[1] = "tipo_red";
  ajax_field_list[2] = "vinculo";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idred": {"label": "Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_red": {"label": "Tipo Red", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "vinculo": {"label": "Vinculo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["idred"][1] = "idred";
  ajax_field_mult["tipo_red"][1] = "tipo_red";
  ajax_field_mult["vinculo"][1] = "vinculo";

  var ajax_field_id = {
    "tipo_red": new Array("hidden_field_label_tipo_red", "hidden_field_data_tipo_red"),
    "vinculo": new Array("hidden_field_label_vinculo", "hidden_field_data_vinculo")
  };
