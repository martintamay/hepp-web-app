  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_redes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idred
  function do_ajax_form_redes_validate_idred()
  {
    var nomeCampo_idred = "idred";
    var var_idred = scAjaxGetFieldHidden(nomeCampo_idred);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_redes_validate_idred(var_idred, var_script_case_init, do_ajax_form_redes_validate_idred_cb);
  } // do_ajax_form_redes_validate_idred

  function do_ajax_form_redes_validate_idred_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_redes_validate_idred_cb

  // ---------- Validate tipo_red
  function do_ajax_form_redes_validate_tipo_red()
  {
    var nomeCampo_tipo_red = "tipo_red";
    var var_tipo_red = scAjaxGetFieldRadio(nomeCampo_tipo_red);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_redes_validate_tipo_red(var_tipo_red, var_script_case_init, do_ajax_form_redes_validate_tipo_red_cb);
  } // do_ajax_form_redes_validate_tipo_red

  function do_ajax_form_redes_validate_tipo_red_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_redes_validate_tipo_red_cb

  // ---------- Validate vinculo
  function do_ajax_form_redes_validate_vinculo()
  {
    var nomeCampo_vinculo = "vinculo";
    var var_vinculo = scAjaxGetFieldText(nomeCampo_vinculo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_redes_validate_vinculo(var_vinculo, var_script_case_init, do_ajax_form_redes_validate_vinculo_cb);
  } // do_ajax_form_redes_validate_vinculo

  function do_ajax_form_redes_validate_vinculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "vinculo";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_redes_validate_vinculo_cb
  // ---------- Form
  function do_ajax_form_redes_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_redes_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_redes_submit_form(var_idred, var_tipo_red, var_vinculo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_redes_submit_form_cb);
  } // do_ajax_form_redes_submit_form

  function do_ajax_form_redes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_redes_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_redes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_redes_navigate_form(var_idred, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_redes_navigate_form_cb);
  } // do_ajax_form_redes_navigate_form

  function do_ajax_form_redes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_redes_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_redes_navigate_form_cb
