...
function scEventControl_init(iSeqRow) {
  scEventControl_data["idfuncionarios" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": ""};
  scEventControl_data["nombre" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": ""};
  scEventControl_data["puesto" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": ""};
...
function scEventControl_active(iSeqRow) {
  if (scEventControl_data["idfuncionarios" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["idfuncionarios" + iSeqRow]["change"]) {
    return true;
  }
  ...
  if (scEventControl_data["puesto" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["puesto" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idfuncionarios' + iSeqRow).bind('blur', function() { sc_form_funcionarios_idfuncionarios_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_funcionarios_idfuncionarios_onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre' + iSeqRow).bind('blur', function() { sc_form_funcionarios_nombre_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_funcionarios_nombre_onfocus(this, iSeqRow) });
  $('#id_sc_field_puesto' + iSeqRow).bind('blur', function() { sc_form_funcionarios_puesto_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_funcionarios_puesto_onfocus(this, iSeqRow) });
  $('#id_sc_field_numero' + iSeqRow).bind('blur', function() { sc_form_funcionarios_numero_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_funcionarios_numero_onfocus(this, iSeqRow) });
  $('#id_sc_field_imagen' + iSeqRow).bind('blur', function() { sc_form_funcionarios_imagen_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_funcionarios_imagen_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_funcionarios_idfuncionarios_onblur(oThis, iSeqRow) {
  do_ajax_form_funcionarios_mob_validate_idfuncionarios();
  scCssBlur(oThis);
}

function sc_form_funcionarios_idfuncionarios_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_funcionarios_nombre_onblur(oThis, iSeqRow) {
  do_ajax_form_funcionarios_mob_validate_nombre();
  scCssBlur(oThis);
}

function sc_form_funcionarios_nombre_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_funcionarios_puesto_onblur(oThis, iSeqRow) {
  do_ajax_form_funcionarios_mob_validate_puesto();
  scCssBlur(oThis);
}

function sc_form_funcionarios_puesto_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_funcionarios_numero_onblur(oThis, iSeqRow) {
  do_ajax_form_funcionarios_mob_validate_numero();
  scCssBlur(oThis);
}

function sc_form_funcionarios_numero_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_funcionarios_imagen_onblur(oThis, iSeqRow) {
  scCssBlur(oThis);
}

function sc_form_funcionarios_imagen_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}
