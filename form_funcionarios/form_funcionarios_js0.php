<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idfuncionarios" value="<?php echo NM_encode_input($this->nmgp_dados_form['idfuncionarios']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionarios']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
</form> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionarios']['where_detal']))
  {
?>  
