  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_funcionarios_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idfuncionarios
  function do_ajax_form_funcionarios_mob_validate_idfuncionarios()
  {
    var nomeCampo_idfuncionarios = "idfuncionarios";
    var var_idfuncionarios = scAjaxGetFieldHidden(nomeCampo_idfuncionarios);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionarios_mob_validate_idfuncionarios(var_idfuncionarios, var_script_case_init, do_ajax_form_funcionarios_mob_validate_idfuncionarios_cb);
  } // do_ajax_form_funcionarios_mob_validate_idfuncionarios

  function do_ajax_form_funcionarios_mob_validate_idfuncionarios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idfuncionarios";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionarios_mob_validate_idfuncionarios_cb

  // ---------- Validate nombre
  function do_ajax_form_funcionarios_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionarios_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_funcionarios_mob_validate_nombre_cb);
  } // do_ajax_form_funcionarios_mob_validate_nombre

  function do_ajax_form_funcionarios_mob_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombre";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionarios_mob_validate_nombre_cb

  // ---------- Validate puesto
  function do_ajax_form_funcionarios_mob_validate_puesto()
  {
    var nomeCampo_puesto = "puesto";
    var var_puesto = scAjaxGetFieldText(nomeCampo_puesto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionarios_mob_validate_puesto(var_puesto, var_script_case_init, do_ajax_form_funcionarios_mob_validate_puesto_cb);
  } // do_ajax_form_funcionarios_mob_validate_puesto

  function do_ajax_form_funcionarios_mob_validate_puesto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "puesto";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionarios_mob_validate_puesto_cb

  // ---------- Validate numero
  function do_ajax_form_funcionarios_mob_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionarios_mob_validate_numero(var_numero, var_script_case_init, do_ajax_form_funcionarios_mob_validate_numero_cb);
  } // do_ajax_form_funcionarios_mob_validate_numero

  function do_ajax_form_funcionarios_mob_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "numero";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionarios_mob_validate_numero_cb

  // ---------- Validate imagen
  function do_ajax_form_funcionarios_mob_validate_imagen()
  {
    var nomeCampo_imagen = "imagen";
    var var_imagen = scAjaxGetFieldText(nomeCampo_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionarios_mob_validate_imagen(var_imagen, var_script_case_init, do_ajax_form_funcionarios_mob_validate_imagen_cb);
  } // do_ajax_form_funcionarios_mob_validate_imagen

  function do_ajax_form_funcionarios_mob_validate_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "imagen";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionarios_mob_validate_imagen_cb
  // ---------- Form
  function do_ajax_form_funcionarios_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_funcionarios_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idfuncionarios = scAjaxGetFieldHidden("idfuncionarios");
    var var_nombre = scAjaxGetFieldText("nombre");
    var var_puesto = scAjaxGetFieldText("puesto");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_funcionarios_mob_submit_form(var_idfuncionarios, var_nombre, var_puesto, var_numero, var_imagen, var_imagen_ul_name, var_imagen_ul_type, var_imagen_salva, var_imagen_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_funcionarios_mob_submit_form_cb);
  } // do_ajax_form_funcionarios_mob_submit_form

  function do_ajax_form_funcionarios_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idfuncionarios");
      scAjaxHideErrorDisplay("nombre");
      scAjaxHideErrorDisplay("puesto");
  ...
  } // do_ajax_form_funcionarios_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_funcionarios_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("numero");
    scAjaxHideErrorDisplay("imagen");
    var var_idfuncionarios = document.F2.idfuncionarios.value;
    ...
    scAjaxProcOn();
    x_ajax_form_funcionarios_mob_navigate_form(var_idfuncionarios, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_funcionarios_mob_navigate_form_cb);
  } // do_ajax_form_funcionarios_mob_navigate_form

  function do_ajax_form_funcionarios_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idfuncionarios.value = scAjaxGetKeyValue("idfuncionarios");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_funcionarios_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_funcionarios_mob_navigate_form_cb
  ...
  ajax_field_list[0] = "idfuncionarios";
  ajax_field_list[1] = "nombre";
  ajax_field_list[2] = "puesto";
  ajax_field_list[3] = "numero";
  ajax_field_list[4] = "imagen";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idfuncionarios": {"label": "Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nombre": {"label": "Nombre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "puesto": {"label": "Puesto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "idfuncionarios": new Array(),
    "nombre": new Array(),
    "puesto": new Array(),
    "numero": new Array(),
    "imagen": new Array()
  };
  ajax_field_mult["idfuncionarios"][1] = "idfuncionarios";
  ajax_field_mult["nombre"][1] = "nombre";
  ajax_field_mult["puesto"][1] = "puesto";
  ajax_field_mult["numero"][1] = "numero";
  ajax_field_mult["imagen"][1] = "imagen";

  var ajax_field_id = {
    "idfuncionarios": new Array("hidden_field_label_idfuncionarios", "hidden_field_data_idfuncionarios"),
    "nombre": new Array("hidden_field_label_nombre", "hidden_field_data_nombre"),
    "puesto": new Array("hidden_field_label_puesto", "hidden_field_data_puesto"),
