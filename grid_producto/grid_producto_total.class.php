...
class grid_producto_total
{
   ...
   //----- 
   function grid_producto_total($sc_page)
   {
      $this->sc_page = $sc_page;
      $this->nm_data = new nm_data("es");
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_producto']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_producto']['campos_busca']))
      { 
   ...
   function quebra_geral()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_producto']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_producto']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_producto']['where_pesq']; 
      } 
      else 
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_producto']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_producto']['tot_geral'][0] = "Total Compra"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_producto']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_producto']['contr_total_geral'] = "OK";
   } 
