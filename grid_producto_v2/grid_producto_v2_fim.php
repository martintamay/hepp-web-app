...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["hepp_____grid_producto_v2"]))
   {
      unset($_SESSION['session_sec_aplicacao']["hepp_____grid_producto_v2"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_producto_v2']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_producto_v2']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_producto_v2']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_producto_v2']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_producto_v2']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_producto_v2']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_producto_v2']['embutida_filho'] as $ind => $sc_init)
          {
