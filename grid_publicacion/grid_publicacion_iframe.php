...
$oExportPdf = new grid_publicacion_export_pdf;
$oExportPdf->exportPdf();

class grid_publicacion_export_pdf {
...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_titl'] ?> - publicacion :: PDF</title>
...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_publicacion_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_publicacion']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_publicacion']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_publicacion.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_publicacion']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_publicacion']['pdf_name'] : "grid_publicacion.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
