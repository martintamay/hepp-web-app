...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["hepp_____grid_publicacion"]))
   {
      unset($_SESSION['session_sec_aplicacao']["hepp_____grid_publicacion"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_publicacion'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_publicacion']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_publicacion']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_publicacion']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_publicacion']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_publicacion']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_publicacion']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_publicacion']['embutida_filho'] as $ind => $sc_init)
          {
