<?php
   ...
   session_start();
    $Ord_Cmp = new grid_funcionarios_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_funcionarios_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['idfuncionarios'] = "on";
   $tab_def_campos['idfuncionarios'] = "idfuncionarios";
   $tab_converte["idfuncionarios"]   = "idfuncionarios";
   $tab_labels["idfuncionarios"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionarios']['labels']["idfuncionarios"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionarios']['labels']["idfuncionarios"] : "Id";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "nombre";
   $tab_converte["nombre"]   = "nombre";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionarios']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionarios']['labels']["nombre"] : "Nombre";
   $tab_ger_campos['puesto'] = "on";
   $tab_def_campos['puesto'] = "puesto";
   $tab_converte["puesto"]   = "puesto";
   $tab_labels["puesto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionarios']['labels']["puesto"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionarios']['labels']["puesto"] : "Puesto";
   $tab_ger_campos['numero'] = "on";
   $tab_def_campos['numero'] = "numero";
   $tab_converte["numero"]   = "numero";
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionarios']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionarios']['labels']["numero"] : "Numero";
   $tab_ger_campos['imagen'] = "on";
   $tab_def_campos['imagen'] = "imagen";
   $tab_converte["imagen"]   = "imagen";
   $tab_labels["imagen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionarios']['labels']["imagen"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionarios']['labels']["imagen"] : "Imagen";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_funcionarios']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_funcionarios']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_funcionarios']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_funcionarios']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_funcionarios']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_funcionarios']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_funcionarios']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_funcionarios']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_funcionarios']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - funcionarios</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_funcionarios_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_funcionarios']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_funcionarios']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
