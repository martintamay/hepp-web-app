...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idfuncionarios";$Nm_numeric[] = "idfuncionarios";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_idfuncionarios"  <?php echo $str_hide_idfuncionarios?>><?php
      $idfuncionarios_look = substr($this->Db->qstr($idfuncionarios), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idfuncionarios" name="idfuncionarios_autocomp" size="10" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_idfuncionarios"  <?php echo $str_display_idfuncionarios; ?> class="scFilterFieldFontOdd">
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_puesto"  <?php echo $str_hide_puesto?>><?php
      $puesto_look = substr($this->Db->qstr($puesto), 1, -1); 
      $nmgp_def_dados = array(); 
