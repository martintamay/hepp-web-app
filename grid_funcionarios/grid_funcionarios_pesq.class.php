...
class grid_funcionarios_pesq
{
    ...
    * @access  public
    */
   function grid_funcionarios_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_funcionarios_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_funcionarios_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_funcionarios_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idfuncionarios')
      {
          $idfuncionarios = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idfuncionarios($idfuncionarios);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_puesto')
      {
          $puesto = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_puesto($puesto);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_idfuncionarios($idfuncionarios)
   {
      $idfuncionarios = substr($this->Db->qstr($idfuncionarios), 1, -1);
            $idfuncionarios_look = substr($this->Db->qstr($idfuncionarios), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct idfuncionarios from " . $this->Ini->nm_tabela . " where  idfuncionarios like '%" . $idfuncionarios . "%'"; 
   ...
   function lookup_ajax_puesto($puesto)
   {
      $puesto = substr($this->Db->qstr($puesto), 1, -1);
            $puesto_look = substr($this->Db->qstr($puesto), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct puesto from " . $this->Ini->nm_tabela . " where  puesto like '%" . $puesto . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_numero($numero)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct numero from " . $this->Ini->nm_tabela . " where  numero like '%" . $numero . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - funcionarios</TITLE>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_funcionarios_ajax_search.js"></script>
 <script type="text/javascript" src="grid_funcionarios_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_idfuncionarios_cond#NMF#' + search_get_sel_txt('SC_idfuncionarios_cond') + '@NMF@';
  str_out += 'SC_idfuncionarios#NMF#' + search_get_text('SC_idfuncionarios') + '@NMF@';
  str_out += 'id_ac_idfuncionarios#NMF#' + search_get_text('id_ac_idfuncionarios') + '@NMF@';
  str_out += 'SC_idfuncionarios_input_2#NMF#' + search_get_text('SC_idfuncionarios_input_2') + '@NMF@';
  ...
  str_out += 'SC_puesto_cond#NMF#' + search_get_sel_txt('SC_puesto_cond') + '@NMF@';
  str_out += 'SC_puesto#NMF#' + search_get_text('SC_puesto') + '@NMF@';
  str_out += 'id_ac_puesto#NMF#' + search_get_text('id_ac_puesto') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_idfuncionarios").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_idfuncionarios",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_idfuncionarios").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_idfuncionarios").val( $(this).val() );
       }
     }
   });
   ...
   $("#id_ac_puesto").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_puesto",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_puesto").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_puesto").val( $(this).val() );
       }
     }
   });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - funcionarios</span></td>
...
<?php
   ...
   {
      global 
             $idfuncionarios_cond, $idfuncionarios, $idfuncionarios_input_2, $idfuncionarios_autocomp,
             $nombre_cond, $nombre, $nombre_autocomp,
             $puesto_cond, $puesto, $puesto_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $idfuncionarios = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['idfuncionarios']; 
          $idfuncionarios_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['idfuncionarios_input_2']; 
          $idfuncionarios_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['idfuncionarios_cond']; 
          $nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['nombre']; 
          $nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['nombre_cond']; 
          $puesto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['puesto']; 
          $puesto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['puesto_cond']; 
          $numero = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['numero']; 
          $numero_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['numero_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['NM_operador']; 
      } 
      if (!isset($idfuncionarios_cond) || empty($idfuncionarios_cond))
      {
         $idfuncionarios_cond = "gt";
      }
      if (!isset($nombre_cond) || empty($nombre_cond))
      {
         $nombre_cond = "qp";
      }
      if (!isset($puesto_cond) || empty($puesto_cond))
      {
         $puesto_cond = "qp";
      }
      ...
      $str_hide_idfuncionarios = (in_array($idfuncionarios_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nombre = (in_array($nombre_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_puesto = (in_array($puesto_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_numero = (in_array($numero_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_idfuncionarios = ('bw' == $idfuncionarios_cond) ? $display_aberto : $display_fechado;

      if (!isset($idfuncionarios) || $idfuncionarios == "")
      {
          $idfuncionarios = "";
      }
      if (isset($idfuncionarios) && !empty($idfuncionarios))
      {
         $tmp_pos = strpos($idfuncionarios, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idfuncionarios = substr($idfuncionarios, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($puesto, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $puesto = substr($puesto, 0, $tmp_pos);
         }
      }
...
<?php
   if (is_file("grid_funcionarios_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['idfuncionarios'])) ? $this->New_label['idfuncionarios'] : "Id"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idfuncionarios_cond" name="idfuncionarios_cond" onChange="nm_campos_between(document.getElementById('id_vis_idfuncionarios'), this, 'idfuncionarios')">
       <OPTION value="gt" <?php if ("gt" == $idfuncionarios_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idfuncionarios_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idfuncionarios_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $idfuncionarios_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idfuncionarios" <?php echo $str_hide_idfuncionarios?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['idfuncionarios'])) ? $this->New_label['idfuncionarios'] : "Id";
 $nmgp_tab_label .= "idfuncionarios?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $idfuncionarios_look = substr($this->Db->qstr($idfuncionarios), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($idfuncionarios))
   { 
      $nm_comando = "select distinct idfuncionarios from " . $this->Ini->nm_tabela . " where idfuncionarios = $idfuncionarios_look"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$idfuncionarios]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idfuncionarios];
      }
      else
      {
          $sAutocompValue = $idfuncionarios;
      }
?>
<INPUT  type="text" id="SC_idfuncionarios" name="idfuncionarios" value="<?php echo NM_encode_input($idfuncionarios) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idfuncionarios" name="idfuncionarios_autocomp" size="10" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_idfuncionarios"  <?php echo $str_display_idfuncionarios; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idfuncionarios_input_2" name="idfuncionarios_input_2" value="<?php echo NM_encode_input($idfuncionarios_input_2) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
...
?>
<INPUT  type="text" id="SC_nombre" name="nombre" value="<?php echo NM_encode_input($nombre) ?>" size=26 alt="{datatype: 'text', maxLength: 26, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nombre" name="nombre_autocomp" size="26" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 26, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['puesto'])) ? $this->New_label['puesto'] : "Puesto"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_puesto_cond" name="puesto_cond" onChange="nm_campos_between(document.getElementById('id_vis_puesto'), this, 'puesto')">
       <OPTION value="qp" <?php if ("qp" == $puesto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $puesto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $puesto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $puesto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_puesto" <?php echo $str_hide_puesto?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['puesto'])) ? $this->New_label['puesto'] : "Puesto";
 $nmgp_tab_label .= "puesto?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $puesto_look = substr($this->Db->qstr($puesto), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct puesto from " . $this->Ini->nm_tabela . " where puesto = '$puesto_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$puesto]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$puesto];
      }
      else
      {
          $sAutocompValue = $puesto;
      }
?>
<INPUT  type="text" id="SC_puesto" name="puesto" value="<?php echo NM_encode_input($puesto) ?>" size=24 alt="{datatype: 'text', maxLength: 24, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_puesto" name="puesto_autocomp" size="24" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 24, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['numero'])) ? $this->New_label['numero'] : "Numero"; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<?php
      $numero_look = substr($this->Db->qstr($numero), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct numero from " . $this->Ini->nm_tabela . " where numero = '$numero_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_numero" name="numero" value="<?php echo NM_encode_input($numero) ?>" size=24 alt="{datatype: 'text', maxLength: 24, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_numero" name="numero_autocomp" size="24" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 24, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_funcionarios']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_funcionarios']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_idfuncionarios'), document.F1.idfuncionarios_cond, 'idfuncionarios');
   document.F1.idfuncionarios.value = "";
   document.F1.idfuncionarios_autocomp.value = "";
   document.F1.idfuncionarios_input_2.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_puesto'), document.F1.puesto_cond, 'puesto');
   document.F1.puesto.value = "";
   document.F1.puesto_autocomp.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "hepp/grid_funcionarios";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_idfuncionarios_cond'] = 'cond';
      $tp_fields['SC_idfuncionarios'] = 'text_aut';
      $tp_fields['id_ac_idfuncionarios'] = 'text_aut';
      $tp_fields['SC_idfuncionarios_input_2'] = 'text';
      $tp_fields['SC_nombre_cond'] = 'cond';
      $tp_fields['SC_nombre'] = 'text_aut';
      $tp_fields['id_ac_nombre'] = 'text_aut';
      $tp_fields['SC_puesto_cond'] = 'cond';
      $tp_fields['SC_puesto'] = 'text_aut';
      $tp_fields['id_ac_puesto'] = 'text_aut';
   ...
   {
      global $idfuncionarios_cond, $idfuncionarios, $idfuncionarios_input_2, $idfuncionarios_autocomp,
             $nombre_cond, $nombre, $nombre_autocomp,
             $puesto_cond, $puesto, $puesto_autocomp,
      ...
      if (!empty($idfuncionarios_autocomp) && empty($idfuncionarios))
      {
          $idfuncionarios = $idfuncionarios_autocomp;
      }
      if (!empty($nombre_autocomp) && empty($nombre))
      {
          $nombre = $nombre_autocomp;
      }
      if (!empty($puesto_autocomp) && empty($puesto))
      {
          $puesto = $puesto_autocomp;
      }
      if (!empty($numero_autocomp) && empty($numero))
      {
          $numero = $numero_autocomp;
      }
      $idfuncionarios_cond_salva = $idfuncionarios_cond; 
      if (!isset($idfuncionarios_input_2) || $idfuncionarios_input_2 == "")
      {
          $idfuncionarios_input_2 = $idfuncionarios;
      }
      ...
      $puesto_cond_salva = $puesto_cond; 
      if (!isset($puesto_input_2) || $puesto_input_2 == "")
      {
          $puesto_input_2 = $puesto;
      }
      ...
      if ($idfuncionarios_cond != "in")
      {
          nm_limpa_numero($idfuncionarios, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $idfuncionarios);
          ...
          $idfuncionarios = implode(",", $Nm_sc_valores);
      }
      if ($idfuncionarios_cond != "in")
      {
          nm_limpa_numero($idfuncionarios_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['idfuncionarios'] = $idfuncionarios; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['idfuncionarios_input_2'] = $idfuncionarios_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['idfuncionarios_cond'] = $idfuncionarios_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['nombre'] = $nombre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['nombre_cond'] = $nombre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['puesto'] = $puesto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['puesto_cond'] = $puesto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['numero'] = $numero; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['numero_cond'] = $numero_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!is_numeric($idfuncionarios) && $idfuncionarios_cond != "in")
      {
          $idfuncionarios = "";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['idfuncionarios'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['idfuncionarios'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['idfuncionarios'] = $idfuncionarios;
      }
      $Conteudo = $idfuncionarios_input_2;
      if (strtoupper($idfuncionarios_cond) != "II" && strtoupper($idfuncionarios_cond) != "QP" && strtoupper($idfuncionarios_cond) != "NP" && strtoupper($idfuncionarios_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['idfuncionarios_input_2'] = $Conteudo;
      $nombre_look = substr($this->Db->qstr($nombre), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombre from " . $this->Ini->nm_tabela . " where nombre = '$nombre_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['puesto'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['puesto'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['puesto'] = $puesto;
      }
      $numero_look = substr($this->Db->qstr($numero), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct numero from " . $this->Ini->nm_tabela . " where numero = '$numero_look'"; 
      ...
      if (isset($idfuncionarios) || $idfuncionarios_cond == "nu" || $idfuncionarios_cond == "nn" || $idfuncionarios_cond == "ep" || $idfuncionarios_cond == "ne")
      {
         $this->monta_condicao("idfuncionarios", $idfuncionarios_cond, $idfuncionarios, $idfuncionarios_input_2, "idfuncionarios");
      }
      ...
      //----- $puesto
      $this->Date_part = false;
      if (isset($puesto) || $puesto_cond == "nu" || $puesto_cond == "nn" || $puesto_cond == "ep" || $puesto_cond == "ne")
      {
         $this->monta_condicao("puesto", $puesto_cond, $puesto, "", "puesto");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionarios']['where_pesq_ant'] = $this->comando . $this->comando_fim;
