...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate nombre
  function do_ajax_contacto_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_contacto_validate_nombre(var_nombre, var_script_case_init, do_ajax_contacto_validate_nombre_cb);
  } // do_ajax_contacto_validate_nombre

  function do_ajax_contacto_validate_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_contacto_validate_nombre_cb

  // ---------- Validate telefono
  function do_ajax_contacto_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_contacto_validate_telefono(var_telefono, var_script_case_init, do_ajax_contacto_validate_telefono_cb);
  } // do_ajax_contacto_validate_telefono

  function do_ajax_contacto_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_contacto_validate_telefono_cb

  // ---------- Validate correo
  function do_ajax_contacto_validate_correo()
  {
    var nomeCampo_correo = "correo";
    var var_correo = scAjaxGetFieldText(nomeCampo_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_contacto_validate_correo(var_correo, var_script_case_init, do_ajax_contacto_validate_correo_cb);
  } // do_ajax_contacto_validate_correo

  function do_ajax_contacto_validate_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "correo";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_contacto_validate_correo_cb

  // ---------- Validate contenido
  function do_ajax_contacto_validate_contenido()
  {
    var nomeCampo_contenido = "contenido";
    var var_contenido = scAjaxGetFieldText(nomeCampo_contenido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_contacto_validate_contenido(var_contenido, var_script_case_init, do_ajax_contacto_validate_contenido_cb);
  } // do_ajax_contacto_validate_contenido

  function do_ajax_contacto_validate_contenido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_contacto_validate_contenido_cb
  // ---------- Form
  function do_ajax_contacto_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_contacto_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_contacto_submit_form(var_nombre, var_telefono, var_correo, var_contenido, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_contacto_submit_form_cb);
  } // do_ajax_contacto_submit_form

  function do_ajax_contacto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_contacto_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_contacto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_contacto_navigate_form

  function do_ajax_contacto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_contacto_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_contacto_navigate_form_cb
