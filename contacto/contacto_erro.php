...
$old_error_handler = set_error_handler("contacto_scriptcase_error_handler");

function contacto_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['contacto']['contr_erro']) && $_SESSION['scriptcase']['contacto']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_contacto->contr_contacto->Apl_com_erro = true;
            if ($inicial_contacto->contr_contacto->NM_ajax_flag)
            {
                $inicial_contacto->contr_contacto->NM_ajax_info['errList']['geral_contacto'][] = $msg;
                return;
            }
            contacto_scriptcase_error_display($msg, $err_no);
        }
...
function contacto_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['contacto'])  && '' != $_SESSION['scriptcase']['error_icon']['contacto'])  ? $_SESSION['scriptcase']['error_icon']['contacto']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['contacto']) && '' != $_SESSION['scriptcase']['error_close']['contacto']) ? $_SESSION['scriptcase']['error_close']['contacto'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['contacto']) && '' != $_SESSION['scriptcase']['error_span_title']['contacto']) ? $_SESSION['scriptcase']['error_span_title']['contacto'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['contacto']) && '' != $_SESSION['scriptcase']['error_icon_title']['contacto']) ? $_SESSION['scriptcase']['error_icon_title']['contacto'] : '';
?>
