...
$old_error_handler = set_error_handler("contacto_mob_scriptcase_error_handler");

function contacto_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['contacto_mob']['contr_erro']) && $_SESSION['scriptcase']['contacto_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_contacto_mob->contr_contacto_mob->Apl_com_erro = true;
            if ($inicial_contacto_mob->contr_contacto_mob->NM_ajax_flag)
            {
                $inicial_contacto_mob->contr_contacto_mob->NM_ajax_info['errList']['geral_contacto_mob'][] = $msg;
                return;
            }
            contacto_mob_scriptcase_error_display($msg, $err_no);
        }
...
function contacto_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['contacto_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['contacto_mob'])  ? $_SESSION['scriptcase']['error_icon']['contacto_mob']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['contacto_mob']) && '' != $_SESSION['scriptcase']['error_close']['contacto_mob']) ? $_SESSION['scriptcase']['error_close']['contacto_mob'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['contacto_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['contacto_mob']) ? $_SESSION['scriptcase']['error_span_title']['contacto_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['contacto_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['contacto_mob']) ? $_SESSION['scriptcase']['error_icon_title']['contacto_mob'] : '';
?>
