  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_correos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idcorreos
  function do_ajax_form_correos_validate_idcorreos()
  {
    var nomeCampo_idcorreos = "idcorreos";
    var var_idcorreos = scAjaxGetFieldHidden(nomeCampo_idcorreos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_correos_validate_idcorreos(var_idcorreos, var_script_case_init, do_ajax_form_correos_validate_idcorreos_cb);
  } // do_ajax_form_correos_validate_idcorreos

  function do_ajax_form_correos_validate_idcorreos_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_correos_validate_idcorreos_cb

  // ---------- Validate nombre
  function do_ajax_form_correos_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_correos_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_correos_validate_nombre_cb);
  } // do_ajax_form_correos_validate_nombre

  function do_ajax_form_correos_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombre";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_correos_validate_nombre_cb

  // ---------- Validate correo
  function do_ajax_form_correos_validate_correo()
  {
    var nomeCampo_correo = "correo";
    var var_correo = scAjaxGetFieldText(nomeCampo_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_correos_validate_correo(var_correo, var_script_case_init, do_ajax_form_correos_validate_correo_cb);
  } // do_ajax_form_correos_validate_correo

  function do_ajax_form_correos_validate_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "correo";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_correos_validate_correo_cb
  // ---------- Form
  function do_ajax_form_correos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_correos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_correos_submit_form(var_idcorreos, var_nombre, var_correo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_correos_submit_form_cb);
  } // do_ajax_form_correos_submit_form

  function do_ajax_form_correos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_correos_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_correos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_correos_navigate_form(var_idcorreos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_correos_navigate_form_cb);
  } // do_ajax_form_correos_navigate_form

  function do_ajax_form_correos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_correos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_correos_navigate_form_cb
