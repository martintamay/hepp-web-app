...
$oExportPdf = new grid_pag_export_pdf;
$oExportPdf->exportPdf();

class grid_pag_export_pdf {
...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_pag_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_pag']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_pag']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_pag.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_pag']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_pag']['pdf_name'] : "grid_pag.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
