...
$oExportPdf = new grid_producto_web_export_pdf;
$oExportPdf->exportPdf();

class grid_producto_web_export_pdf {
...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_titl'] ?> - producto :: PDF</title>
...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_producto_web_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_producto_web']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_producto_web']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_producto_web.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_producto_web']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_producto_web']['pdf_name'] : "grid_producto_web.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
