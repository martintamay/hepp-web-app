<?php
   ...
   session_start();
    $Ord_Cmp = new grid_producto_web_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_producto_web_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["idproducto"]   = "idproducto";
   $tab_labels["idproducto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_producto_web']['labels']["idproducto"])) ? $_SESSION['sc_session'][$sc_init]['grid_producto_web']['labels']["idproducto"] : "Id";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "nombre";
   $tab_converte["nombre"]   = "nombre";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_producto_web']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_producto_web']['labels']["nombre"] : "Nombre";
   $tab_ger_campos['imagen'] = "on";
   $tab_def_campos['imagen'] = "imagen";
   $tab_converte["imagen"]   = "imagen";
   $tab_labels["imagen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_producto_web']['labels']["imagen"])) ? $_SESSION['sc_session'][$sc_init]['grid_producto_web']['labels']["imagen"] : "Imagen";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_producto_web']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_producto_web']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_producto_web']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_producto_web']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_producto_web']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_producto_web']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_producto_web']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_producto_web']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_producto_web']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_producto_web_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_producto_web']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_producto_web']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
