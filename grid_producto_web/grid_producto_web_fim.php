...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["hepp_____grid_producto_web"]))
   {
      unset($_SESSION['session_sec_aplicacao']["hepp_____grid_producto_web"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_producto_web'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_producto_web']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_producto_web']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_producto_web']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_producto_web']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_producto_web']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_producto_web']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_producto_web']['embutida_filho'] as $ind => $sc_init)
          {
