...
class grid_producto_v3_total
{
   ...
   //----- 
   function grid_producto_v3_total($sc_page)
   {
      $this->sc_page = $sc_page;
      $this->nm_data = new nm_data("es");
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_producto_v3']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_producto_v3']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_producto_v3']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_producto_v3']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_producto_v3']['where_pesq']; 
      } 
      else 
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_producto_v3']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_producto_v3']['tot_geral'][0] = "Total Compra"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_producto_v3']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_producto_v3']['contr_total_geral'] = "OK";
   } 

   //-----  grupo
   function quebra_grupo_Grupo($grupo, $arg_sum_grupo) 
   {
      global $tot_grupo ;  
      $tot_grupo = array() ;  
      $tot_grupo[0] = $grupo ; 
