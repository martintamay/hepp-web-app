  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_producto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate cantidad_
  function do_ajax_form_producto_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldRadio(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_producto_validate_cantidad__cb);
  } // do_ajax_form_producto_validate_cantidad_

  function do_ajax_form_producto_validate_cantidad__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_validate_cantidad__cb

  // ---------- Validate codigo_
  function do_ajax_form_producto_validate_codigo_(iNumLinha)
  {
    var nomeCampo_codigo_ = "codigo_" + iNumLinha;
    var var_codigo_ = scAjaxGetFieldHidden(nomeCampo_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_validate_codigo_(var_codigo_, iNumLinha, var_script_case_init, do_ajax_form_producto_validate_codigo__cb);
  } // do_ajax_form_producto_validate_codigo_

  function do_ajax_form_producto_validate_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_validate_codigo__cb

  // ---------- Validate descripcion_
  function do_ajax_form_producto_validate_descripcion_(iNumLinha)
  {
    var nomeCampo_descripcion_ = "descripcion_" + iNumLinha;
    var var_descripcion_ = scAjaxGetFieldHidden(nomeCampo_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_validate_descripcion_(var_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_producto_validate_descripcion__cb);
  } // do_ajax_form_producto_validate_descripcion_

  function do_ajax_form_producto_validate_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_validate_descripcion__cb

  // ---------- Validate precio1_
  function do_ajax_form_producto_validate_precio1_(iNumLinha)
  {
    var nomeCampo_precio1_ = "precio1_" + iNumLinha;
    var var_precio1_ = scAjaxGetFieldText(nomeCampo_precio1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_validate_precio1_(var_precio1_, iNumLinha, var_script_case_init, do_ajax_form_producto_validate_precio1__cb);
  } // do_ajax_form_producto_validate_precio1_

  function do_ajax_form_producto_validate_precio1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "precio1_" + iLineNumber;
    }
    else
    {
      sFieldValid = "precio1_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "precio1_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "precio1_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_producto_validate_precio1__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_producto_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_producto_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_producto_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_producto_add_new_line_cb);
  } // do_ajax_form_producto_add_new_line

  function do_ajax_form_producto_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_producto_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_producto_backup_line(iNumLinha)
  {
    var var_orden_ = scAjaxGetFieldText("orden_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_producto_backup_line(var_orden_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_producto_backup_line_cb);
  } // do_ajax_form_producto_backup_line

  function do_ajax_form_producto_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_producto_backup_line_cb

  function do_ajax_form_producto_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_producto_cancel_insert

  function do_ajax_form_producto_cancel_update(iSeqVert)
  {
    do_ajax_form_producto_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_producto_cancel_update

  function do_ajax_form_producto_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_producto_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_producto_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_producto_table_refresh(var_orden_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_producto_table_refresh_cb);
  } //  do_ajax_form_producto_table_refresh

  function do_ajax_form_producto_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_producto_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_producto_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_producto_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_cantidad_ = scAjaxGetFieldRadio("cantidad_" + iNumLinha);
    var var_codigo_ = scAjaxGetFieldHidden("codigo_" + iNumLinha);
    var var_descripcion_ = scAjaxGetFieldHidden("descripcion_" + iNumLinha);
    var var_precio1_ = scAjaxGetFieldText("precio1_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_producto_submit_form(var_cantidad_, var_codigo_, var_descripcion_, var_precio1_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_producto_submit_form_cb);
  } // do_ajax_form_producto_submit_form

  function do_ajax_form_producto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("precio1_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_form_producto_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_producto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_producto_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("precio1_" + iNavForm);
    }
    var var_orden_ = document.F2.orden_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_producto_navigate_form(var_orden_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_producto_navigate_form_cb);
  } // do_ajax_form_producto_navigate_form

  function do_ajax_form_producto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
...
?>
  ...
  } // do_ajax_form_producto_navigate_form_cb
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "precio1_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["precio1_" + iNumLinha] = {"label": "PRECIO1<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["precio1_"][iNumLinha] = "precio1_" + iNumLinha;
    ...
    ajax_field_id["precio1_" + iNumLinha] = new Array("hidden_field_label_precio1_", "hidden_field_data_precio1_" + iNumLinha);
    ...
    ajax_error_count["precio1_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["precio1_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["precio1_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["precio1_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["precio1_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["precio1_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["precio1_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["precio1_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["precio1_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['precio1_'])) ? $this->nmgp_cmp_readonly['precio1_'] : 'off';
?>
    scAjaxFieldRead("precio1_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("precio1_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["cantidad_" + iRow] || "on" == ajax_error_count["codigo_" + iRow] || "on" == ajax_error_count["descripcion_" + iRow] || "on" == ajax_error_count["precio1_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_precio1_" + iRow))
        document.getElementById("hidden_field_data_precio1_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["cantidad_" + iRow] && "off" == ajax_error_count["codigo_" + iRow] && "off" == ajax_error_count["descripcion_" + iRow] && "off" == ajax_error_count["precio1_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["precio1_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_precio1_" + iRow))
        document.getElementById("hidden_field_data_precio1_" + iRow).className = sCssLine;
    }
  }
