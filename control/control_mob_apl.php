...
//
      ...
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          if ($Campos_Crit == "" && empty($Campos_Falta) && $this->Campos_Mens_erro == "" && !isset($this->bok) && $this->nmgp_opcao != "recarga")
          {
              ...
              { 
                  $vacio = $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['campos'][0]; 
                  $cuenta = $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['campos'][1]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      elseif (isset($this->bok) && $this->bok == "OK")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['campos'][0] = $this->vacio; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['campos'][1] = $this->cuenta; 
