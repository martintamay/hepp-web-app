...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate vacio
  function do_ajax_control_mob_validate_vacio()
  {
    var nomeCampo_vacio = "vacio";
    var var_vacio = scAjaxGetFieldHidden(nomeCampo_vacio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_mob_validate_vacio(var_vacio, var_script_case_init, do_ajax_control_mob_validate_vacio_cb);
  } // do_ajax_control_mob_validate_vacio

  function do_ajax_control_mob_validate_vacio_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_mob_validate_vacio_cb

  // ---------- Validate cuenta
  function do_ajax_control_mob_validate_cuenta()
  {
    var nomeCampo_cuenta = "cuenta";
    var var_cuenta = scAjaxGetFieldText(nomeCampo_cuenta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_mob_validate_cuenta(var_cuenta, var_script_case_init, do_ajax_control_mob_validate_cuenta_cb);
  } // do_ajax_control_mob_validate_cuenta

  function do_ajax_control_mob_validate_cuenta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cuenta";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_mob_validate_cuenta_cb
  // ---------- Form
  function do_ajax_control_mob_submit_form()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_control_mob_submit_form(var_vacio, var_cuenta, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_control_mob_submit_form_cb);
