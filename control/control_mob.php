...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['control_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'hepp'); 
      } 
      else 
      { 
...
//
    ...
    {
        if ('ajax_control_mob_validate_vacio' == $_POST['rs'])
        {
            $vacio = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_control_mob_validate_cuenta' == $_POST['rs'])
        {
    ...
    else
    {
        ...
        if (isset($_POST["razonsocial"])) 
        {
            ...
            nm_limpa_str_control_mob($_SESSION['razonsocial']);
        }
        ...
        if (isset($_POST["cuenta"])) 
        {
            ...
            nm_limpa_str_control_mob($_SESSION['cuenta']);
        }
        ...
        if (isset($_POST["v_total"])) 
        {
            ...
            nm_limpa_str_control_mob($_SESSION['v_total']);
        }
    ...
    sajax_init();
    //$sajax_debug_mode = 1;
    sajax_export("ajax_control_mob_validate_vacio");
    sajax_export("ajax_control_mob_validate_cuenta");
...
//
    ...
    function ajax_control_mob_validate_vacio($vacio, $script_case_init)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
        $inicial_control_mob->contr_control_mob->NM_ajax_opcao         = 'validate_vacio';
    ...
    function ajax_control_mob_validate_cuenta($cuenta, $script_case_init)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
        $inicial_control_mob->contr_control_mob->NM_ajax_opcao         = 'validate_cuenta';
        $inicial_control_mob->contr_control_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_control_mob_submit_form($vacio, $cuenta, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
