<?php
   include_once('grid_red_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['grid_red']['glo_nm_perfil']          = "web";
   $_SESSION['scriptcase']['grid_red']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['grid_red']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['grid_red']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['grid_red']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['grid_red']['glo_nm_path_doc']        = "";
//
class grid_red_ini
{
   var $nm_cod_apl;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_red']['decimal_db'] = "."; 

      $this->nm_cod_apl      = "grid_red"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      $this->nm_grupo        = "hepp"; 
      ...
      $this->nm_hr_criacao   = "175546"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20160925"; 
      $this->nm_hr_ult_alt   = "181153"; 
...
// 
      ...
      //check prod
      if(empty($_SESSION['scriptcase']['grid_red']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['grid_red']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
      //check img
      if(empty($_SESSION['scriptcase']['grid_red']['glo_nm_path_imagens']))
      {
              /*check img*/$_SESSION['scriptcase']['grid_red']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
      }
      //check tmp
      if(empty($_SESSION['scriptcase']['grid_red']['glo_nm_path_imag_temp']))
      {
              /*check tmp*/$_SESSION['scriptcase']['grid_red']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
      }
      //check doc
      if(empty($_SESSION['scriptcase']['grid_red']['glo_nm_path_doc']))
      {
              /*check doc*/$_SESSION['scriptcase']['grid_red']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
      }
      //end check publication with the prod
      $this->sc_site_ssl     = (isset($_SERVER['HTTP_REFERER']) && strtolower(substr($_SERVER['HTTP_REFERER'], 0, 5)) == 'https') ? true : false;
      $this->sc_protocolo    = ($this->sc_site_ssl) ? 'https://' : 'http://';
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['grid_red']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['grid_red']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['grid_red']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['grid_red']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['grid_red']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/grid_red';
      ...
      {
          include_once("grid_red_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['grid_red']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['grid_red']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['grid_red']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['grid_red']['SC_Link_View'] = true;
          }
      }
...
<?php
      ...
      $this->link_form_redes =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_redes') . "/" ; 
      if ($Tp_init == "Path_sub")
      {
          return;
      }
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['grid_red']['glo_nm_conexao']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_red']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['grid_red']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['grid_red']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['grid_red']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "grid_red_erro.class.php"); 
      $this->Erro = new grid_red_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('grid_red'); 
// 
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_red']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['grid_red']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      ob_start();
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['grid_red']['glo_nm_conexao']) && $_SESSION['scriptcase']['grid_red']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_red']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_red']['glo_nm_perfil']) && $_SESSION['scriptcase']['grid_red']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_red']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_red']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['grid_red']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['grid_red']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['grid_red']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['grid_red']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_red']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['grid_red']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['grid_red']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['grid_red']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_red']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['grid_red']['embutida_init']) 
      {
      }
// 
      if (isset($_SESSION['scriptcase']['glo_decimal_db']) && !empty($_SESSION['scriptcase']['glo_decimal_db']))
      {
         $_SESSION['sc_session'][$this->sc_page]['grid_red']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['grid_red']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_red']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_red']['glo_nm_conexao'], $this->root . $this->path_prod, 'hepp'); 
      } 
      else 
      { 
...
//===============================================================================
//
class grid_red_sub_css
{
   function grid_red_sub_css()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['grid_red']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['grid_red']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['grid_red'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['grid_red']['embutida'])
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_grid_red($cadapar[1]);
                       nm_protect_num_grid_red($cadapar[0], $cadapar[1]);
                       $$cadapar[0] = $cadapar[1];
                   }
              }
          } 
      ...
      if (!$this->Ini) 
      { 
          $this->Ini = new grid_red_ini(); 
          $this->Ini->init();
      } 
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['grid_red']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['grid_red'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_red']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_red']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('grid_red') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_red']['label'] = "" . $this->Ini->Nm_lang['lang_othr_grid_titl'] . " - red";
      ...
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("es");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "grid_red/grid_red_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "grid_red_erro.class.php"); 
      } 
      $this->Erro      = new grid_red_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "grid_red/grid_red_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "grid_red_lookup.class.php"); 
      } 
      $this->Lookup       = new grid_red_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['scroll_navigate'] = false;
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_navigate")
          {
              ob_start();
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['ajax_nav'] = true;
              $_SESSION['scriptcase']['saida_var']  = true;
              $_SESSION['scriptcase']['saida_html'] = "";
              $this->Ini->Arr_result = array();
              $nmgp_opcao = $_POST['opc'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'] = $nmgp_opcao;
              if (isset($_POST['parm']) && $_POST['parm'] == "save_grid")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['save_grid'] = true;
              }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['pdf_det'] = false;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida_treeview'] = false;
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['field_order'][] = "idred";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['field_order'][] = "tipo_red";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['field_order'][] = "vinculo";
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_red']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_red']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['grid_red']['exit'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['where_orig']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'] = "inicio" ;  
      }   
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_red']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_red']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'] = "busca";
          }   
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida_form'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'] == "busca")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'] = "inicio";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opc_liga'] = $NMSC_conf_apl;  
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['print_all'] = true;
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'] = 'inicio';
          } 
      } 
//
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"]))  
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['prim_cons'] = true;  
   ...
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['where_pesq_filtro'];
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida'])
      {
         ...
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_red_html_" . session_id() . "_2.html";
            ...
            {
                $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "_grid_red.pdf";
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            }
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_red_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->java_protocol . $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_grid_red_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['word_name']))
          {
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_grid_red_res_" . session_id() . ".doc";
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . grid_red . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
          } 
          $this->Graf  = new grid_red_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'], 8));
          }
          else
          { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "grid_red_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_red_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new grid_red_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'] == "resumo")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_red/" . $this->Ini->Apl_resumo); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
          } 
          $this->Res = new grid_red_resumo("out");
          $this->prep_modulos("Res");
          $this->Res->monta_resumo();
      }
      else 
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['doc_word']  = true;
              ...
              {
                  $nm_arquivo_doc_word = "/sc_grid_red_" . session_id() . ".doc";
              }
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_red/grid_red_grid.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_red_grid.class.php"); 
          } 
          $this->grid  = new grid_red_grid();
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['embutida'])
      {
         ...
         {
             $this->Ini->Arr_result['setVar'][] = array('var' => 'scQtReg', 'value' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['qt_reg_grid']);
             $Temp = ob_get_clean();
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['pdf_det'])
            {
            ...
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['pdf_name']))
            {
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['pdf_name']);
            }
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_red']['pdf_file'] = $nm_arquivo_pdf_serv;
}
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if (!is_file($nm_arquivo_pdf_serv))
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - red :: Doc</TITLE>
...
<form name="Fdown" method="get" action="grid_red_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="nm_tit_doc" value="grid_red.doc"> 
...
//======= =========================
   ...
   SC_dir_app_ini('hepp');
   $_SESSION['scriptcase']['grid_red']['contr_erro'] = 'off';
   $sc_conv_var = array();
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_grid_red($nmgp_val);
            nm_protect_num_grid_red($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_red']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_red']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['grid_red']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['grid_red']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['grid_red']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['grid_red']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_red']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['grid_red']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['grid_red']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['grid_red']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['grid_red']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['grid_red']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['grid_red']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['grid_red']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['grid_red']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_red']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_red']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_red']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['grid_red']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['grid_red']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['grid_red']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_red']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['grid_red']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['grid_red']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['grid_red']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['grid_red']);
               $_SESSION['sc_session'][$script_case_init]['grid_red']['b_sair'] = false;
           }   
       } 
   } 
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_red']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_red']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['grid_red']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['grid_red']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['grid_red']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['grid_red']['protect_modal']) && !empty($_SESSION['scriptcase']['grid_red']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['grid_red']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   $_SESSION['sc_session'][$script_case_init]['grid_red']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_red']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['grid_red']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_red']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_red']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['grid_red']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_red']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "grid_red";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'grid_red' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['grid_red']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['grid_red']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['grid_red']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_red']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_red']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_red']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/grid_red/'))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_red']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['grid_red']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_red']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['grid_red']['contr_total_geral'] = "NAO";
   }

   $_POST['script_case_init'] = $script_case_init;
   if (isset($nmgp_opcao) && $nmgp_opcao == "busca" && isset($nmgp_orig_pesq))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_red']['orig_pesq'] = $nmgp_orig_pesq;
   }
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['grid_red']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_red']['b_sair'] = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'grid_red')
   {
       $_SESSION['sc_session'][$script_case_init]['grid_red']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['grid_red']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/grid_red_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['grid_red']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_red']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_red']['opcao'] = $nmgp_opcao ;  
       }   
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_red']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['grid_red']['mostra_edit'] = "S";
       }
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['grid_red']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_red']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['grid_red']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['grid_red']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['grid_red']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['grid_red']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['grid_red']['volta_redirect_tp'] = "";
           $nm_url_saida = "grid_red_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['grid_red']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_red']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['grid_red']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_red']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['grid_red']['sc_modal'] = true;
               }
               $nm_url_saida = "grid_red_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['grid_red']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['grid_red']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['grid_red']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['grid_red']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_red']['opcao'] != "pdf" ) 
       { 
            $_SESSION['sc_session'][$script_case_init]['grid_red']['menu_desenv'] = true;   
       } 
       if (isset($_GET["nmgp_parms_ret"])) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_red']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['grid_red']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['grid_red']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['grid_red']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['grid_red']['opc_psq'] = true ;   
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['grid_red']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_red']['opc_psq'] = false ;   
       } 
       if ($_SESSION['sc_session'][$script_case_init]['grid_red']['embutida_form'])
       {
           $_SESSION['sc_session'][$script_case_init]['grid_red']['mostra_edit'] = "N";   
       ...
       if (!$_SESSION['sc_session'][$script_case_init]['grid_red']['opc_psq']) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_red']) || $_SESSION['scriptcase']['sc_apl_seg']['grid_red'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['grid_red']['iframe_menu']) ? false : true;
...
<?php
       ...
       $contr_grid_red = new grid_red_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['grid_red']['opcao'] = "busca";
          $contr_grid_red->NM_ajax_flag = true;
          $contr_grid_red->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_red']['opcao'] = "busca";
          $contr_grid_red->NM_ajax_flag = true;
          $contr_grid_red->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_red']['opcao'] = "busca";
          $contr_grid_red->NM_ajax_flag = true;
          $contr_grid_red->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_red']['opcao'] = "busca";
          $contr_grid_red->NM_ajax_flag = true;
          $contr_grid_red->NM_ajax_opcao = "ajax_filter_select";
      }
       $contr_grid_red->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['grid_red']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_grid_red(&$str)
   {
   ...
   function nm_protect_num_grid_red($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function grid_red_pack_protect_string($sString)
   {
