...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["hepp_____grid_red"]))
   {
      unset($_SESSION['session_sec_aplicacao']["hepp_____grid_red"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_redes'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_red']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_red']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_red']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_red']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_red']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_red']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_red']['embutida_filho'] as $ind => $sc_init)
          {
