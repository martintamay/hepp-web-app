...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["menu_web"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_web"]["glo_nm_path_prod"]; ?>/third/jquery/js/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_web"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    </head>
    <body>
    <?php
        escreveMenuMobile($menu_web_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
