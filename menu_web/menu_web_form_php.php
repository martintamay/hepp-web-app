...
class menu_web_form_php
{
   ...
   function init()
   {
      ...
      //check prod
      if(!isset($_SESSION['scriptcase']['menu_web']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['menu_web']['glo_nm_path_prod']))
      {
...
<?php
      ...
      if ($_SESSION['scriptcase']['sc_item_menu'] == "menu_web")
      {
              $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_parametros") . "/?nm_run_menu=1&nm_apl_menu=menu_web&script_case_init=1&script_case_session=" . session_id() . "";
      }
      elseif (isset($_SESSION['scriptcase']['sc_def_menu']['menu_web']))
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['menu_web'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_parametros") . "/?nm_run_menu=1&nm_apl_menu=menu_web&script_case_init=" . $this->Gera_sc_init('form_parametros') . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_2")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_publicacion") . "/?nm_run_menu=1&nm_apl_menu=menu_web&script_case_init=" . $this->Gera_sc_init('grid_publicacion') . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_5")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_pag") . "/?nm_run_menu=1&nm_apl_menu=menu_web&script_case_init=" . $this->Gera_sc_init('grid_pag') . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_6")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_correos") . "/?nm_run_menu=1&nm_apl_menu=menu_web&script_case_init=" . $this->Gera_sc_init('grid_correos') . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_4")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_usuario") . "/?nm_run_menu=1&nm_apl_menu=menu_web&script_case_init=" . $this->Gera_sc_init('form_usuario') . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_8")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_funcionarios") . "/?nm_run_menu=1&nm_apl_menu=menu_web&script_case_init=" . $this->Gera_sc_init('grid_funcionarios') . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_9")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_producto_web") . "/?nm_run_menu=1&nm_apl_menu=menu_web&script_case_init=" . $this->Gera_sc_init('grid_producto_web') . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_3")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_red") . "/?nm_run_menu=1&nm_apl_menu=menu_web&script_case_init=" . $this->Gera_sc_init('grid_red') . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_11")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_producto_modificar") . "/?nm_run_menu=1&nm_apl_menu=menu_web&script_case_init=" . $this->Gera_sc_init('form_producto_modificar') . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_7")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("control_web") . "/?script_case_init=" . $_SESSION['sc_session'][1]['menu_web']['init'] . "&script_case_session=" . session_id() . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="menu_web"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "menu_web")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'menu_web', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
SC_dir_app_ini('hepp');
$controle = new menu_web_form_php();
$controle->init();
?>
