  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pag_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idpag
  function do_ajax_form_pag_mob_validate_idpag()
  {
    var nomeCampo_idpag = "idpag";
    var var_idpag = scAjaxGetFieldHidden(nomeCampo_idpag);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pag_mob_validate_idpag(var_idpag, var_script_case_init, do_ajax_form_pag_mob_validate_idpag_cb);
  } // do_ajax_form_pag_mob_validate_idpag

  function do_ajax_form_pag_mob_validate_idpag_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pag_mob_validate_idpag_cb

  // ---------- Validate titulo
  function do_ajax_form_pag_mob_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldText(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pag_mob_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_pag_mob_validate_titulo_cb);
  } // do_ajax_form_pag_mob_validate_titulo

  function do_ajax_form_pag_mob_validate_titulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "titulo";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pag_mob_validate_titulo_cb

  // ---------- Validate contenido
  function do_ajax_form_pag_mob_validate_contenido()
  {
    var nomeCampo_contenido = "contenido";
    var var_contenido = scAjaxGetFieldText(nomeCampo_contenido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pag_mob_validate_contenido(var_contenido, var_script_case_init, do_ajax_form_pag_mob_validate_contenido_cb);
  } // do_ajax_form_pag_mob_validate_contenido

  function do_ajax_form_pag_mob_validate_contenido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pag_mob_validate_contenido_cb

  // ---------- Validate img
  function do_ajax_form_pag_mob_validate_img()
  {
    var nomeCampo_img = "img";
    var var_img = scAjaxGetFieldText(nomeCampo_img);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pag_mob_validate_img(var_img, var_script_case_init, do_ajax_form_pag_mob_validate_img_cb);
  } // do_ajax_form_pag_mob_validate_img

  function do_ajax_form_pag_mob_validate_img_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "img";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pag_mob_validate_img_cb
  // ---------- Form
  function do_ajax_form_pag_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pag_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idpag = scAjaxGetFieldHidden("idpag");
    var var_titulo = scAjaxGetFieldText("titulo");
    var var_contenido = scAjaxGetFieldText("contenido");
    var var_img = scAjaxGetFieldText("img");
    var var_img_ul_name = scAjaxSpecCharProtect(document.F1.img_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_img_ul_type = document.F1.img_ul_type.value;
    var var_img_salva = scAjaxSpecCharProtect(document.F1.img_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_img_limpa = document.F1.img_limpa.checked ? "S" : "N";
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_pag_mob_submit_form(var_idpag, var_titulo, var_contenido, var_img, var_img_ul_name, var_img_ul_type, var_img_salva, var_img_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_pag_mob_submit_form_cb);
  } // do_ajax_form_pag_mob_submit_form

  function do_ajax_form_pag_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.img_limpa && document.F1.img_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("img", oImgTemp, "", "", "", "N");
      }
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
  ...
  } // do_ajax_form_pag_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_pag_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("contenido");
    scAjaxHideErrorDisplay("img");
    var var_idpag = document.F2.idpag.value;
    ...
    scAjaxProcOn();
    x_ajax_form_pag_mob_navigate_form(var_idpag, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pag_mob_navigate_form_cb);
  } // do_ajax_form_pag_mob_navigate_form

  function do_ajax_form_pag_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idpag.value = scAjaxGetKeyValue("idpag");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    document.F1.img_ul_name.value = '';
    document.F1.img_ul_type.value = '';
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert();
    scAjaxMessage();
...
{
?>
    do_ajax_form_pag_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_pag_mob_navigate_form_cb
  ...
  ajax_field_list[0] = "idpag";
  ajax_field_list[1] = "titulo";
  ajax_field_list[2] = "contenido";
  ajax_field_list[3] = "img";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idpag": {"label": "Idpag", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["idpag"][1] = "idpag";
  ajax_field_mult["titulo"][1] = "titulo";
  ajax_field_mult["contenido"][1] = "contenido";
  ajax_field_mult["img"][1] = "img";

  var ajax_field_id = {
    "idpag": new Array("hidden_field_label_idpag", "hidden_field_data_idpag"),
