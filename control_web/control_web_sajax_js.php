  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_web" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate usr
  function do_ajax_control_web_validate_usr()
  {
    var nomeCampo_usr = "usr";
    var var_usr = scAjaxGetFieldText(nomeCampo_usr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_web_validate_usr(var_usr, var_script_case_init, do_ajax_control_web_validate_usr_cb);
  } // do_ajax_control_web_validate_usr

  function do_ajax_control_web_validate_usr_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_web_validate_usr_cb

  // ---------- Validate pass
  function do_ajax_control_web_validate_pass()
  {
    var nomeCampo_pass = "pass";
    var var_pass = scAjaxGetFieldText(nomeCampo_pass);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_web_validate_pass(var_pass, var_script_case_init, do_ajax_control_web_validate_pass_cb);
  } // do_ajax_control_web_validate_pass

  function do_ajax_control_web_validate_pass_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pass";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_web_validate_pass_cb
  // ---------- Form
  function do_ajax_control_web_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_web_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_control_web_submit_form(var_usr, var_pass, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_control_web_submit_form_cb);
  } // do_ajax_control_web_submit_form

  function do_ajax_control_web_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_web_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_web_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_web_navigate_form

  function do_ajax_control_web_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_web_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_web_navigate_form_cb
