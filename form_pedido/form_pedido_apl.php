...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['cliente_cuenta']))
          {
              $this->cliente_cuenta = $this->NM_ajax_info['param']['cliente_cuenta'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['ordenproducto']))
          {
              $this->ordenproducto = $this->NM_ajax_info['param']['ordenproducto'];
          }
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_pedido']['parms']))
      {
          ...
          {
              $todo = explode("?@?", $_SESSION['sc_session'][$script_case_init]['form_pedido']['parms']);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
                 $cadapar = explode("?#?", $todo[$ix]);
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_pedido']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_pedido']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - pedido";
      ...
      $_SESSION['scriptcase']['error_icon']['form_pedido']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      if ($this->nmgp_opcao == "fast_search")  
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido']['opcao'] = "inicio";
...
//
      ...
      if (isset($this->cliente_cuenta)) { $this->nm_limpa_alfa($this->cliente_cuenta); }
      if (isset($this->cantidad)) { $this->nm_limpa_alfa($this->cantidad); }
      if (isset($this->fraccionado)) { $this->nm_limpa_alfa($this->fraccionado); }
      if (isset($this->subtotal)) { $this->nm_limpa_alfa($this->subtotal); }
      if (isset($this->ordenproducto)) { $this->nm_limpa_alfa($this->ordenproducto); }
      $Campos_Crit       = "";
      $Campos_erro       = "";
      $Campos_Falta      = array();
      $Campos_Erros      = array();
   ...
   function loadFieldConfig()
   {
      ...
      //-- cliente_cuenta
      $this->field_config['cliente_cuenta']               = array();
      $this->field_config['cliente_cuenta']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_val'];
      $this->field_config['cliente_cuenta']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit'];
      $this->field_config['cliente_cuenta']['symbol_dec'] = $_SESSION['scriptcase']['reg_conf']['dec_val'];
      $this->field_config['cliente_cuenta']['symbol_mon'] = '';
      $this->field_config['cliente_cuenta']['format_pos'] = $_SESSION['scriptcase']['reg_conf']['monet_f_pos'];
      $this->field_config['cliente_cuenta']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['monet_f_neg'];
      //-- cantidad
      ...
      $this->field_config['fraccionado']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_val'];
      $this->field_config['fraccionado']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit'];
      $this->field_config['fraccionado']['symbol_dec'] = $_SESSION['scriptcase']['reg_conf']['dec_val'];
      $this->field_config['fraccionado']['symbol_mon'] = '';
      $this->field_config['fraccionado']['format_pos'] = $_SESSION['scriptcase']['reg_conf']['monet_f_pos'];
      $this->field_config['fraccionado']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['monet_f_neg'];
      //-- subtotal
      ...
      //-- ordenproducto
      $this->field_config['ordenproducto']               = array();
      $this->field_config['ordenproducto']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ordenproducto']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ordenproducto']['symbol_dec'] = '';
      $this->field_config['ordenproducto']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ordenproducto']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_cliente_cuenta' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'cliente_cuenta');
          }
          ...
          if ('validate_ordenproducto' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'ordenproducto');
          }
...
//---------------------------------------------------------
     $this->sc_force_zero = array();
      ...
      if ('' == $filtro || 'cliente_cuenta' == $filtro)
        $this->ValidateField_cliente_cuenta($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ('' == $filtro || 'ordenproducto' == $filtro)
        $this->ValidateField_ordenproducto($Campos_Crit, $Campos_Falta, $Campos_Erros);
    ...
    function ValidateField_idpedido(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->idpedido, 10, 0, 0, 0, "N") == false)  
              { 
    ...
    function ValidateField_cliente_cuenta(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->cliente_cuenta == "")  
      { 
          $this->cliente_cuenta = 0;
          $this->sc_force_zero[] = 'cliente_cuenta';
      } 
      if (!empty($this->field_config['cliente_cuenta']['symbol_dec']))
      {
          $this->sc_remove_currency($this->cliente_cuenta, $this->field_config['cliente_cuenta']['symbol_dec'], $this->field_config['cliente_cuenta']['symbol_grp'], $this->field_config['cliente_cuenta']['symbol_mon']); 
          nm_limpa_valor($this->cliente_cuenta, $this->field_config['cliente_cuenta']['symbol_dec'], $this->field_config['cliente_cuenta']['symbol_grp']) ; 
          if ('.' == substr($this->cliente_cuenta, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->cliente_cuenta, 1)))
              {
                  $this->cliente_cuenta = '';
              }
              else
              {
                  $this->cliente_cuenta = '0' . $this->cliente_cuenta;
              }
          }
      }
      ...
      { 
          ...
          { 
              $iTestSize = 13;
              if (strlen($this->cliente_cuenta) > $iTestSize)  
              { 
                  $Campos_Crit .= "Cliente Cuenta: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['cliente_cuenta']))
                  {
                      $Campos_Erros['cliente_cuenta'] = array();
                  }
                  $Campos_Erros['cliente_cuenta'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['cliente_cuenta']) || !is_array($this->NM_ajax_info['errList']['cliente_cuenta']))
                  {
                      $this->NM_ajax_info['errList']['cliente_cuenta'] = array();
                  }
                  $this->NM_ajax_info['errList']['cliente_cuenta'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->cliente_cuenta, 12, 0, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Cliente Cuenta; " ; 
                  if (!isset($Campos_Erros['cliente_cuenta']))
                  {
                      $Campos_Erros['cliente_cuenta'] = array();
                  }
                  $Campos_Erros['cliente_cuenta'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['cliente_cuenta']) || !is_array($this->NM_ajax_info['errList']['cliente_cuenta']))
                  {
                      $this->NM_ajax_info['errList']['cliente_cuenta'] = array();
                  }
                  $this->NM_ajax_info['errList']['cliente_cuenta'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_cliente_cuenta
    ...
    function ValidateField_cantidad(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->cantidad, 12, 0, 0, 0, "N") == false)  
              { 
    ...
    function ValidateField_fraccionado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if (!empty($this->field_config['fraccionado']['symbol_dec']))
      {
          $this->sc_remove_currency($this->fraccionado, $this->field_config['fraccionado']['symbol_dec'], $this->field_config['fraccionado']['symbol_grp'], $this->field_config['fraccionado']['symbol_mon']); 
          nm_limpa_valor($this->fraccionado, $this->field_config['fraccionado']['symbol_dec'], $this->field_config['fraccionado']['symbol_grp']) ; 
          if ('.' == substr($this->fraccionado, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->fraccionado, 1)))
              {
                  $this->fraccionado = '';
              }
              else
              {
                  $this->fraccionado = '0' . $this->fraccionado;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "Fraccionado: " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              if ($teste_validade->Valor($this->fraccionado, 12, 0, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Fraccionado; " ; 
                  if (!isset($Campos_Erros['fraccionado']))
                  {
                      $Campos_Erros['fraccionado'] = array();
                  }
    ...
    function ValidateField_ordenproducto(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->ordenproducto == "")  
      { 
          $this->ordenproducto = 0;
          $this->sc_force_zero[] = 'ordenproducto';
      } 
      nm_limpa_numero($this->ordenproducto, $this->field_config['ordenproducto']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->ordenproducto != '')  
          { 
              $iTestSize = 10;
              if (strlen($this->ordenproducto) > $iTestSize)  
              { 
                  $Campos_Crit .= "Ordenproducto: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['ordenproducto']))
                  {
                      $Campos_Erros['ordenproducto'] = array();
                  }
                  $Campos_Erros['ordenproducto'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['ordenproducto']) || !is_array($this->NM_ajax_info['errList']['ordenproducto']))
                  {
                      $this->NM_ajax_info['errList']['ordenproducto'] = array();
                  }
                  $this->NM_ajax_info['errList']['ordenproducto'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->ordenproducto, 10, 0, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Ordenproducto; " ; 
                  if (!isset($Campos_Erros['ordenproducto']))
                  {
                      $Campos_Erros['ordenproducto'] = array();
                  }
                  $Campos_Erros['ordenproducto'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['ordenproducto']) || !is_array($this->NM_ajax_info['errList']['ordenproducto']))
                  {
                      $this->NM_ajax_info['errList']['ordenproducto'] = array();
                  }
                  $this->NM_ajax_info['errList']['ordenproducto'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_ordenproducto
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['cliente_cuenta'] = $this->cliente_cuenta;
    ...
    $this->nmgp_dados_form['ordenproducto'] = $this->ordenproducto;
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      if (!empty($this->idpedido) || (!empty($format_fields) && isset($format_fields['idpedido'])))
      {
          nmgp_Form_Num_Val($this->idpedido, $this->field_config['idpedido']['symbol_grp'], $this->field_config['idpedido']['symbol_dec'], "0", "S", "", "", "", "-", $this->field_config['idpedido']['symbol_fmt']) ; 
      }
      if (!empty($this->cliente_cuenta) || (!empty($format_fields) && isset($format_fields['cliente_cuenta'])))
      {
          nmgp_Form_Num_Val($this->cliente_cuenta, $this->field_config['cliente_cuenta']['symbol_grp'], $this->field_config['cliente_cuenta']['symbol_dec'], "0", "S", "", "", "", "-", $this->field_config['cliente_cuenta']['symbol_fmt']) ; 
      }
      if (!empty($this->cantidad) || (!empty($format_fields) && isset($format_fields['cantidad'])))
      {
          nmgp_Form_Num_Val($this->cantidad, $this->field_config['cantidad']['symbol_grp'], $this->field_config['cantidad']['symbol_dec'], "0", "S", "", "", "", "-", $this->field_config['cantidad']['symbol_fmt']) ; 
      }
      ...
      {
          nmgp_Form_Num_Val($this->subtotal, $this->field_config['subtotal']['symbol_grp'], $this->field_config['subtotal']['symbol_dec'], "0", "S", "", "", "", "-", $this->field_config['subtotal']['symbol_fmt']) ; 
      }
      if (!empty($this->ordenproducto) || (!empty($format_fields) && isset($format_fields['ordenproducto'])))
      {
          nmgp_Form_Num_Val($this->ordenproducto, $this->field_config['ordenproducto']['symbol_grp'], $this->field_config['ordenproducto']['symbol_dec'], "0", "S", "", "", "", "-", $this->field_config['ordenproducto']['symbol_fmt']) ; 
      }
   }
...
//
   ...
   function ajax_return_values_idpedido($bForce = false)
   {
          ...
          //----- cliente_cuenta
   function ajax_return_values_cliente_cuenta($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("cliente_cuenta", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->cliente_cuenta);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['cliente_cuenta'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
   ...
   function ajax_return_values_subtotal($bForce = false)
   {
          ...
          //----- ordenproducto
   function ajax_return_values_ordenproducto($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("ordenproducto", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->ordenproducto);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['ordenproducto'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
...
//
   ...
   { 
      $this->cliente_cuenta = str_replace($sc_parm1, $sc_parm2, $this->cliente_cuenta); 
      $this->cantidad = str_replace($sc_parm1, $sc_parm2, $this->cantidad); 
      $this->fraccionado = str_replace($sc_parm1, $sc_parm2, $this->fraccionado); 
      $this->subtotal = str_replace($sc_parm1, $sc_parm2, $this->subtotal); 
   } 
   function nm_poe_aspas_decimal() 
   { 
      $this->cliente_cuenta = "'" . $this->cliente_cuenta . "'";
      $this->cantidad = "'" . $this->cantidad . "'";
      $this->fraccionado = "'" . $this->fraccionado . "'";
...
//----------- 
   ...
   { 
      ...
      $NM_val_form['cliente_cuenta'] = $this->cliente_cuenta;
      $NM_val_form['cantidad'] = $this->cantidad;
      $NM_val_form['fraccionado'] = $this->fraccionado;
      $NM_val_form['subtotal'] = $this->subtotal;
      $NM_val_form['ordenproducto'] = $this->ordenproducto;
      if ($this->idpedido == "")  
      { 
          $this->idpedido = 0;
      } 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          {
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select count(*) from " . $this->Ini->nm_tabela . " where idpedido = $this->idpedido ";
              $rs1 = $this->Db->Execute("select count(*) from " . $this->Ini->nm_tabela . " where idpedido = $this->idpedido "); 
          }  
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET cliente_cuenta = $this->cliente_cuenta, cantidad = $this->cantidad, fraccionado = $this->fraccionado, subtotal = $this->subtotal, ordenproducto = $this->ordenproducto";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET cliente_cuenta = $this->cliente_cuenta, cantidad = $this->cantidad, fraccionado = $this->fraccionado, subtotal = $this->subtotal, ordenproducto = $this->ordenproducto";  
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET cliente_cuenta = $this->cliente_cuenta, cantidad = $this->cantidad, fraccionado = $this->fraccionado, subtotal = $this->subtotal, ordenproducto = $this->ordenproducto";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET cliente_cuenta = $this->cliente_cuenta, cantidad = $this->cantidad, fraccionado = $this->fraccionado, subtotal = $this->subtotal, ordenproducto = $this->ordenproducto";  
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['cliente_cuenta'])) { $this->cliente_cuenta = $NM_val_form['cliente_cuenta']; }
              elseif (isset($this->cliente_cuenta)) { $this->nm_limpa_alfa($this->cliente_cuenta); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['fraccionado'])) { $this->fraccionado = $NM_val_form['fraccionado']; }
              elseif (isset($this->fraccionado)) { $this->nm_limpa_alfa($this->fraccionado); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['ordenproducto'])) { $this->ordenproducto = $NM_val_form['ordenproducto']; }
              elseif (isset($this->ordenproducto)) { $this->nm_limpa_alfa($this->ordenproducto); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('idpedido', 'cliente_cuenta', 'cantidad', 'fraccionado', 'subtotal', 'ordenproducto'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (cliente_cuenta, cantidad, fraccionado, subtotal, ordenproducto) VALUES ($this->cliente_cuenta, $this->cantidad, $this->fraccionado, $this->subtotal, $this->ordenproducto)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "cliente_cuenta, cantidad, fraccionado, subtotal, ordenproducto) VALUES (" . $NM_seq_auto . "$this->cliente_cuenta, $this->cantidad, $this->fraccionado, $this->subtotal, $this->ordenproducto)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "cliente_cuenta, cantidad, fraccionado, subtotal, ordenproducto) VALUES (" . $NM_seq_auto . "$this->cliente_cuenta, $this->cantidad, $this->fraccionado, $this->subtotal, $this->ordenproducto)"; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido']['where_filter'])
      {
...
//------------ 
      ...
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
...
//---------- 
      ...
      { 
          ...
          { 
              $nmgp_select = "SELECT idpedido, cliente_cuenta, cantidad, fraccionado, subtotal, ordenproducto from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT idpedido, cliente_cuenta, cantidad, fraccionado, subtotal, ordenproducto from " . $this->Ini->nm_tabela ; 
          ...
          { 
              ...
              $this->cliente_cuenta = $rs->fields[1] ; 
              $this->nmgp_dados_select['cliente_cuenta'] = $this->cliente_cuenta;
              $this->cantidad = $rs->fields[2] ; 
              $this->nmgp_dados_select['cantidad'] = $this->cantidad;
              $this->fraccionado = $rs->fields[3] ; 
              $this->nmgp_dados_select['fraccionado'] = $this->fraccionado;
              $this->subtotal = $rs->fields[4] ; 
              $this->nmgp_dados_select['subtotal'] = $this->subtotal;
              $this->ordenproducto = $rs->fields[5] ; 
              $this->nmgp_dados_select['ordenproducto'] = $this->ordenproducto;
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              $this->nm_troca_decimal(",", ".");
...
<?php
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "idpedido", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "cliente_cuenta", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "fraccionado", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "ordenproducto", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "idpedido", $arg_search, $data_search);
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $nm_numeric[] = "idpedido";$nm_numeric[] = "cliente_cuenta";$nm_numeric[] = "cantidad";$nm_numeric[] = "fraccionado";$nm_numeric[] = "subtotal";$nm_numeric[] = "ordenproducto";
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido']['sc_outra_jan'])
   {
