...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_parametros_validate_idparametros()
  {
    var nomeCampo_idparametros = "idparametros";
    var var_idparametros = scAjaxGetFieldHidden(nomeCampo_idparametros);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_validate_idparametros(var_idparametros, var_script_case_init, do_ajax_form_parametros_validate_idparametros_cb);
  } // do_ajax_form_parametros_validate_idparametros

  function do_ajax_form_parametros_validate_idparametros_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_validate_idparametros_cb

  // ---------- Validate logo
  function do_ajax_form_parametros_validate_logo()
  {
    var nomeCampo_logo = "logo";
    var var_logo = scAjaxGetFieldText(nomeCampo_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_validate_logo(var_logo, var_script_case_init, do_ajax_form_parametros_validate_logo_cb);
  } // do_ajax_form_parametros_validate_logo

  function do_ajax_form_parametros_validate_logo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "logo";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_validate_logo_cb

  // ---------- Validate publ_img
  function do_ajax_form_parametros_validate_publ_img()
  {
    var nomeCampo_publ_img = "publ_img";
    var var_publ_img = scAjaxGetFieldText(nomeCampo_publ_img);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_validate_publ_img(var_publ_img, var_script_case_init, do_ajax_form_parametros_validate_publ_img_cb);
  } // do_ajax_form_parametros_validate_publ_img

  function do_ajax_form_parametros_validate_publ_img_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_validate_publ_img_cb

  // ---------- Validate video
  function do_ajax_form_parametros_validate_video()
  {
    var nomeCampo_video = "video";
    var var_video = scAjaxGetFieldText(nomeCampo_video);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_validate_video(var_video, var_script_case_init, do_ajax_form_parametros_validate_video_cb);
  } // do_ajax_form_parametros_validate_video

  function do_ajax_form_parametros_validate_video_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "video";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_validate_video_cb
  // ---------- Form
  function do_ajax_form_parametros_submit_form()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_parametros_submit_form(var_idparametros, var_logo, var_publ_img, var_video, var_logo_ul_name, var_logo_ul_type, var_publ_img_ul_name, var_publ_img_ul_type, var_logo_salva, var_logo_limpa, var_publ_img_salva, var_publ_img_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_parametros_submit_form_cb);
  ...
  function do_ajax_form_parametros_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_parametros_navigate_form(var_idparametros, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_parametros_navigate_form_cb);
