...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idparametros
  function do_ajax_form_parametros_mob_validate_idparametros()
  {
    var nomeCampo_idparametros = "idparametros";
    var var_idparametros = scAjaxGetFieldHidden(nomeCampo_idparametros);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_mob_validate_idparametros(var_idparametros, var_script_case_init, do_ajax_form_parametros_mob_validate_idparametros_cb);
  } // do_ajax_form_parametros_mob_validate_idparametros

  function do_ajax_form_parametros_mob_validate_idparametros_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idparametros";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_mob_validate_idparametros_cb

  // ---------- Validate logo
  function do_ajax_form_parametros_mob_validate_logo()
  {
    var nomeCampo_logo = "logo";
    var var_logo = scAjaxGetFieldText(nomeCampo_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_mob_validate_logo(var_logo, var_script_case_init, do_ajax_form_parametros_mob_validate_logo_cb);
  } // do_ajax_form_parametros_mob_validate_logo

  function do_ajax_form_parametros_mob_validate_logo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "logo";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_mob_validate_logo_cb

  // ---------- Validate publ_img
  function do_ajax_form_parametros_mob_validate_publ_img()
  {
    var nomeCampo_publ_img = "publ_img";
    var var_publ_img = scAjaxGetFieldText(nomeCampo_publ_img);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_mob_validate_publ_img(var_publ_img, var_script_case_init, do_ajax_form_parametros_mob_validate_publ_img_cb);
  } // do_ajax_form_parametros_mob_validate_publ_img

  function do_ajax_form_parametros_mob_validate_publ_img_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "publ_img";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_mob_validate_publ_img_cb

  // ---------- Validate video
  function do_ajax_form_parametros_mob_validate_video()
  {
    var nomeCampo_video = "video";
    var var_video = scAjaxGetFieldText(nomeCampo_video);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_mob_validate_video(var_video, var_script_case_init, do_ajax_form_parametros_mob_validate_video_cb);
  } // do_ajax_form_parametros_mob_validate_video

  function do_ajax_form_parametros_mob_validate_video_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "video";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_mob_validate_video_cb
  // ---------- Form
  function do_ajax_form_parametros_mob_submit_form()
  {
    ...
    scAjaxHideMessage();
    var var_idparametros = scAjaxGetFieldHidden("idparametros");
    var var_logo = scAjaxGetFieldText("logo");
    var var_publ_img = scAjaxGetFieldText("publ_img");
    ...
    var var_publ_img_ul_name = scAjaxSpecCharProtect(document.F1.publ_img_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_publ_img_ul_type = document.F1.publ_img_ul_type.value;
    ...
    var var_publ_img_salva = scAjaxSpecCharProtect(document.F1.publ_img_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_publ_img_limpa = document.F1.publ_img_limpa.checked ? "S" : "N";
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_parametros_mob_submit_form(var_idparametros, var_logo, var_publ_img, var_video, var_logo_ul_name, var_logo_ul_type, var_publ_img_ul_name, var_publ_img_ul_type, var_logo_salva, var_logo_limpa, var_publ_img_salva, var_publ_img_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_parametros_mob_submit_form_cb);
  ...
  function do_ajax_form_parametros_mob_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idparametros");
      scAjaxHideErrorDisplay("logo");
      scAjaxHideErrorDisplay("publ_img");
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.publ_img_limpa && document.F1.publ_img_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("publ_img", oImgTemp, "", "", "", "N");
      }
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
  ...
  function do_ajax_form_parametros_mob_navigate_form()
  {
    ...
    scAjaxHideErrorDisplay("publ_img");
    scAjaxHideErrorDisplay("video");
    var var_idparametros = document.F2.idparametros.value;
    ...
    scAjaxProcOn();
    x_ajax_form_parametros_mob_navigate_form(var_idparametros, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_parametros_mob_navigate_form_cb);
  ...
  function do_ajax_form_parametros_mob_navigate_form_cb(sResp)
  {
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.idparametros.value = scAjaxGetKeyValue("idparametros");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    document.F1.publ_img_ul_name.value = '';
    document.F1.publ_img_ul_type.value = '';
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert();
    scAjaxMessage();
...
?>
  ...
  ajax_field_list[0] = "idparametros";
  ajax_field_list[1] = "logo";
  ajax_field_list[2] = "publ_img";
  ...
  var ajax_error_list = {
    "idparametros": {"label": "Idparametros", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "logo": {"label": "Logo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "publ_img": {"label": "Imagen Publicitaria", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "idparametros": new Array(),
    "logo": new Array(),
    "publ_img": new Array(),
    "video": new Array()
  };
  ajax_field_mult["idparametros"][1] = "idparametros";
  ajax_field_mult["logo"][1] = "logo";
  ajax_field_mult["publ_img"][1] = "publ_img";
  ajax_field_mult["video"][1] = "video";

  var ajax_field_id = {
    "logo": new Array("hidden_field_label_logo", "hidden_field_data_logo"),
    "publ_img": new Array("hidden_field_label_publ_img", "hidden_field_data_publ_img"),
